...
/**
 * Testcase for a simple entity
 *
 * @license http://www.gnu.org/licenses/lgpl.html GNU Lesser General Public License, version 3 or later
 */
class SimpleEntityTest extends \F3\Testing\BaseTestCase
{
	...
	{
	    $entity = $this->getAccessibleMock('F3\BghObjects\Lib\Model\SimpleEntity', array('dummy'));
